...
([
  ...
  (function (module, exports, __webpack_require__) {
    ...
    var PDFViewerApplication = {
      ...
      bindEvents: function bindEvents() {
        ...
        // TODO:
        // eventBus.on('click', webViewerUploadFile);
      },
    ...
    var webViewerFileInputChange = void 0; {
      webViewerFileInputChange = function webViewerFileInputChange(evt) {
        var file = evt.fileInput.files[0],
          getFilePath = pdfJsApi.getFilePath;

        // 添加 pdfJsApi.getFilePath API
        if (getFilePath) {
          if (Util.os.ie()) {
            getFilePath.call(this, evt.fileInput.value);
          } else if (window.URL) {
            var url = window.URL.createObjectURL(file).replace(/blob:/, '');

            getFilePath.call(pdfJsApi, url);
        ...
        value: function open() {
          ...
          Promise.all([this.overlayManager.open(this.overlayName), this._dataAvailableCapability.promise]).then(function () {
            ...
            _this.pdfDocument.getMetadata().then(function (_ref2) {
              ...
              //PDF作者,设置，PDFAuthor是前台可以传的
              info.Author = initData.PDFAuthor || info.Author;
    ...
    var PDFFindBar = function () {
      ...
      _createClass(PDFFindBar, [{
        ...
        value: function updateUIState(state, previous, matchCount) {
          ...
          switch (state) {
            ...
            case _pdf_find_controller.FindState.NOT_FOUND:
              //not found 换成中文
              findMsg = this.l10n.get('find_not_found', null, '找不到您所查找的内容');
              notFound = true;
              break;
        ...
        value: function toggle(e) {
          //设置搜索菜单位置
          this.bar.style.left = (e.clientX - 10) + 'px';
          if (this.opened) {
            this.close();
          } else {
            this.open();
          ...
          if (this.textLayerFactory) {
            ...
            if (this.annotationLayer && this.annotationLayer.div) {
              ...
              if (signInfo.sign_) {
                ...
                textLayerDiv.appendChild(signInfo.sign_);
              }
      ...
      _createClass(SecondaryToolbar, [{
        ...
        value: function _bindClickListeners() {
          ...
          var _loop = function _loop(button) {
            ...
            element && element.addEventListener('click', function (evt) {
              if (eventName !== null) {
                var details = {
                  source: _this
                };
      ...
      _createClass(Toolbar, [{
        ...
        value: function _bindListeners() {
          ...
          items.closeFile.addEventListener('click', function () {
            var sidebar = appConfig.sidebar;
            var outlineButton = sidebar.outlineButton,
              outlineView = sidebar.outlineView,
              thumbnailButton = sidebar.thumbnailButton,
              mainContainer = appConfig.mainContainer,
              viewer = mainContainer.querySelector('#viewer'),
              thumbnailView = sidebar.thumbnailView;
            ...
            viewer ? viewer.innerHTML = '' : mainContainer.innerHTML = '';
        ...
        value: function _updateUIState() {
          ...
          if (this.hasPageLabels) {
            ...
            this.l10n.get('page_of_pages', {
              pageNumber: pageNumber,
              pagesCount: pagesCount
            }, '({{pageNumber}} / {{pagesCount}})').then(function (msg) {
              items.numPages.textContent = msg;
            });
          } else {
  ...
  (function (module, exports, __webpack_require__) {
    ...
    function webViewerLoad() {
      ...
      pdfJsApi = window.pdfJsApi || {};
      Util.extend(pdfJsApi, defaultSettings);

      // 处理按钮 TODO:
      var val = true;
      var tools = pdfJsApi.tools;
      ...
      var toggleViewOutline = function (val) {
        ...
        val ? outlineButton.removeAttribute('hidden') : outlineButton.setAttribute('hidden', true);
      };

      var toggleViewThumbnail = function (val) {
        var thumbnailButton = sidebar.thumbnailButton;

        val ? thumbnailButton.removeAttribute('hidden') : thumbnailButton.setAttribute('hidden', true);
      };

      var toggleViewAttachments = function (val) {
        var attachmentsButton = sidebar.attachmentsButton;

        val ? attachmentsButton.removeAttribute('hidden') : attachmentsButton.setAttribute('hidden', true);
      };

      var toggleSidebar = function (val) {
        var toggleButton = sidebar.toggleButton;
      ...
      var toggleViewFind = function (val) {
        ...
        val ? viewFind.removeAttribute('hidden') : viewFind.setAttribute('hidden', true);
      };

      var toggleFirstPage = function (val) {
        var firstPageButton = secondaryToolbar.firstPageButton;

        val ? firstPageButton.removeAttribute('hidden') : firstPageButton.setAttribute('hidden', true);
      };

      var toggleLastPage = function (val) {
        var lastPageButton = secondaryToolbar.lastPageButton;

        val ? lastPageButton.removeAttribute('hidden') : lastPageButton.setAttribute('hidden', true);
      };
      ...
      // 监听按钮变化
      Object.defineProperties(pdfJsApi.tools, {
        'viewOutline': {
          set: function (newVal) {
